...
andrea = Contact.create(name: "andrea", company: "PrintABC", activity: "Marketing Specialist", email: "andrea@company1", phone_number: "+1 (714) 496-1099", note: "work with Denis")
tom = Contact.create(name: "tom", company: "ColorFull", activity: "Client Director", email: "tom@company1", phone_number: "+1 (714) 496-1099", note: "no note")
...
yves = Contact.create(name: "Yves", company: "WebHoister", activity: "Marketing Expert", email: "andrea@company1", phone_number: "+1 (714) 496-1099", note: "no note")
dan = Contact.create(name: "Dan", company: "DecalIt", activity: "Advertising Specialist", email: "andrea@company1", phone_number: "+1 (714) 496-1099", note: "no note")
dan2 = Contact.create(name: "Dan", company: "DecalIt", activity: "Advertising Specialist", email: "andrea@company1", phone_number: "+1 (714) 496-1099", note: "no note")
